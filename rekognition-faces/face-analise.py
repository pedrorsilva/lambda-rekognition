...
from constants import IMAGE_BUCKET_NAME, FRONTEND_BUCKET_NAME
...
def publica_dados(dados_json):
  arquivo = s3.Object(FRONTEND_BUCKET_NAME, 'dados.json')
...
# Remover quando inserir no LAMBDA
# Utilizado apenas para teste local
# main(None, None)
